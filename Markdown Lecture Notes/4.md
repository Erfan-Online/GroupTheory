...
(We use the definition of a homomorphism)
$$
...
But the problem is that it isn't an isomorphism of _Groups_!
$$
...
**Note**: $f$ is itself a homomorphism:
$$
f(gg') = f(g) \circ f(g')
$$
...
We can also see the **kernel** of $f$ is:
$$
\begin{align*}
...
i.e. $Aut(G)$ is isomorphic to $S_3$.
...
This map $Aut(G) \rightarrow S_3$ is also surjective (full image), no matter what permutation of $\tau_1, \tau_2, \tau_3$ you use.
